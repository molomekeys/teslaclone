...
export default function ModelS(props) {
    ...
    return (
        <main className="absolute grid place-items-center grid-cols-1 place-content-center gap-3 bg-black">
            ...
            <motion.section className=" place-items-center place-content-center p-20 z-50 mt-20  ">
