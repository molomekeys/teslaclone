    ...
    return (
        <motion.div
            ...
            <motion.ol initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}
                ...
                <li className="   text-xl font-bold lg:text-3xl text-center text-slate-50 font-semi-bold md:flex flex-col">{props.topSpeed} 2.1 <span className="text-sm  lg:inline-block">Vitesse maximal</span></li>
